...
/**
 * Trouve le dernier élément d'un tableau qui correspond à un une condition
 * @param list Tableau à parcourir
 * @param predicate Condition à vérifier
 * @returns Dernier élément du tableau qui correspond à la condition 
 */
export function findLast<T>(list: T[], predicate: (element: T) => boolean): T | undefined {
